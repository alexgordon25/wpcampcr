<?php
/**
 * wpcampcr functions and definitions.
 *
...
if ( ! function_exists( 'wpcampcr_setup' ) ) :
/**
 ...
 */
function wpcampcr_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on wpcampcr, use a find and replace
	 * to change 'wpcampcr' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'wpcampcr', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'wpcampcr' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'wpcampcr_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif;
add_action( 'after_setup_theme', 'wpcampcr_setup' );
 ...
 */
function wpcampcr_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wpcampcr_content_width', 640 );
}
add_action( 'after_setup_theme', 'wpcampcr_content_width', 0 );
 ...
 */
function wpcampcr_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'wpcampcr' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'wpcampcr' ),
...
add_action( 'widgets_init', 'wpcampcr_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function wpcampcr_scripts() {
	wp_enqueue_style( 'wpcampcr-style', get_stylesheet_uri() );

	wp_enqueue_script( 'wpcampcr-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'wpcampcr-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		wp_enqueue_script( 'comment-reply' );
	}
}
add_action( 'wp_enqueue_scripts', 'wpcampcr_scripts' );
